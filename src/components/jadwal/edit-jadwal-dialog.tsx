...
import { updateJadwal } from "@/actions/jadwal-actions"
...
export function EditJadwalDialog({ 
  ...
  async function handleSubmit(formData: FormData) {
    const res = await updateJadwal(jadwal.id, formData)
    if (res.success) {
      onOpenChange(false)
    } else {
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form action={handleSubmit} className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select name="day" defaultValue={jadwal.day} required>
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select name="kelasId" defaultValue={jadwal.kelasId} required>
              <SelectTrigger className="col-span-3">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select name="jamPelajaranId" defaultValue={jadwal.jamPelajaranId} required>
              <SelectTrigger className="col-span-3">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select name="mapelId" defaultValue={jadwal.mapelId || undefined}>
              <SelectTrigger className="col-span-3">
