...
INSERT INTO "new_Nilai" ("category", "createdAt", "gradeType", "id", "letterGrade", "mapelId", "santriId", "score", "ujianId", "updatedAt") SELECT "category", "createdAt", "gradeType", "id", "letterGrade", "mapelId", "santriId", "score", "ujianId", "updatedAt" FROM "Nilai";
DROP TABLE "Nilai";
